<?php
/**
 * Vista de Editar Full Day para Proveedor
 *
...
if (!$post_id) {
    ...
    <div class="crear-container">
        <div class="approval-required">
            ...
            <h2>Full Day No Encontrado</h2>
            <p>El Full Day que intentas editar no existe.</p>
...
// Verificar que el post es del tipo correcto y pertenece al usuario
...
<div class="crear-container">
    <div class="crear-header">
        ...
        <p class="crear-description">Actualiza la información de tu experiencia</p>
    </div>

    <form id="editar-fullday-form" class="crear-form">
        ...
        <div class="form-group">
            ...
            <div class="gallery-upload-container">
                <div class="gallery-preview" id="gallery-preview">
                    <!-- Galería existente se cargará via JavaScript -->
                ...
                <?php
                // Asegurar que gallery es un array válido antes de encodear
        ...
        <div class="form-message" id="editar-message" style="display: none;"></div>

        <!-- Botones -->
        <div class="form-actions">
            <button type="submit" class="btn-crear" id="btn-editar-fullday">
                <span class="btn-text">Actualizar Full Day</span>
